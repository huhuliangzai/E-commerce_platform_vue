          ...
          <div class="row text-center">
            <div class="col-sm-3 p-3 border" v-for="(item,index) in crazy_buy" :key="index">
              <div class="creay_good bg-light">
                <img class="rounded img-fluid" :src="'src/assets/image/crazy_buy/'+item.image" alt="">
                <h5 class="mt-3">
                ...
                <router-link to="/home/buy"><button class="btn btn-outline-danger mb-3">立即购买</button></router-link>
              </div>
            </div>
          </div> 
        </div>
